...
export default function TitleArticles() {
  return (
    <Head>
      ...
      />
      <title>Articles by Tonny Jansen</title>
      <meta
        name="description"
        content="Explore articles authored by Tonny Jansen, a Full Stack Engineer and Developer."
      />
