...
export default function Title500() {
  return (
    <Head>
      ...
      />
      <title>500: internal server error | Tonny Jansen</title>
      <meta
        name="description"
        content="The requested page was occur internal server error "
      />
      ...
      <meta
        name="keywords"
        content="500, internal server error, Tonny Jansen, Portfolio,broken link ,missing page,link not found"
      />
    </Head>
  );
}
